...
var Notification = (function () {
    function Notification(message, settings) {
        ...
        this._settings = jquery.extend(this._defaults, settings);
    ...
    Notification.prototype._compileTemplate = function () {
        var $html = jquery(this._settings.notificationHTML).clone();
...
var NotificationsManager = (function () {
    function NotificationsManager(settings) {
        ...
        this._settings = jquery.extend(this._defaults, settings, true);
    }
...
describe('Single notification component', function () {
    ...
    it('has getType() method returns string', function () {
...
describe('Notifications manager component', function () {
    var $component = jquery_min('<ul id="#notifications"></ul>');
    var notificationsManagerConfig = {
        $componentSelector: jquery_min('#notifications'),
    };
    var NM = null;
    beforeEach(function () {
        jquery_min('body').append($component);
...
}((this.csNotifications = this.csNotifications || {})));
