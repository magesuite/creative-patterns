...
describe('validation-message component', function () {
    var validationMessageComponent = null;
    var settings = null;
    var validationMsgHtml = '<div class="cs-validation-message">text</div>';
    var validationMsgSelector = '.cs-validation-message';
    beforeEach(function () {
        jquery('body').append(validationMsgHtml);
        validationMessageComponent = new ValidationMessage(jquery(validationMsgSelector));
    });
    afterEach(function () {
        jquery('.cs-validation-message').remove();
    });
    // Check if methods exist
    it('has getMessage() method', function () {
        expect(typeof validationMessageComponent.getMessage).toBe('function');
    });
    it('has setMessage() method', function () {
    ...
    it('method getMessage() returns string', function () {
        expect(typeof validationMessageComponent.getMessage()).toBe('string');
    });
    it('method getType() returns string', function () {
        var types = new Map();
    ...
    // Behaviour
    it('method setMessage() sets proper text to component', function () {
        var message = 'ass';
        validationMessageComponent.setMessage(message);
        expect(jquery(validationMsgSelector).text()).toEqual(message);
    });
    it('method getMessage() retrieve proper text message', function () {
        var message = 'ass';
        validationMessageComponent.setMessage(message);
        expect(validationMessageComponent.getMessage()).toEqual(message);
    });
    it('method setType adds proper class to element', function () {
        var types = new Map();
        types.set('positive', 'className');
        settings = {
            types: types,
    ...
    it('method getType returns proper type property', function () {
        var types = new Map();
        types.set('positive', 'className');
        settings = {
            types: types,
...
}((this.csValidationMessage = this.csValidationMessage || {})));
