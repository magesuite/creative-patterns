(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('categoryLinks', ['jquery'], factory) :
...
$('.cs-category-links-dropdown').each(function (index, element) {
    new Flyout($(element), { name: 'cs-category-links-dropdown', type: 'flyout' });
});

})));
//# sourceMappingURL=category-links.js.map
