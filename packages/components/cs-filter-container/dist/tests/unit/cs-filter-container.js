...
describe('Filter container component', function () {
    ...
    it('isExpanded method returns true/false', function () {
        expect(filterContainer.isExpanded()).toMatch(/true|false/);
    });
    it('isExpanded method should be true after expand() method', function () {
        filterContainer.expand();
        expect(filterContainer.isExpanded()).toBeTruthy();
    });
    it('isExpanded method should be false after collapse() method', function () {
        filterContainer.collapse();
        expect(filterContainer.isExpanded()).toBeFalsy();
    });
    it('Filter container should be hidden after collapse() method', function () {
        var $container = jquery('.cs-filter-container__filter-wrapper');
        filterContainer.collapse();
        expect($container.is(':hidden'));
    });
    it('Filter container should be visible after expand() method', function () {
        var $container = jquery('.cs-filter-container__filter-wrapper');
        filterContainer.expand();
...
}((this.csFilterContainer = this.csFilterContainer || {})));
