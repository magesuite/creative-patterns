...
describe('Scrollup arrow component: ', function () {
    ...
    beforeEach(function () {
        $scrollupArrowNode = jquery(scrollupArrowHtml);
    ...
    it('has isVisible() method', function () {
    ...
    it('is visible after show() method', function () {
        scrollupArrow.hide();
        scrollupArrow.show();
        expect($scrollupArrowNode.is(':visible'));
    });
    it('is hidden after hide() method', function () {
        scrollupArrow.show();
        scrollupArrow.hide();
        expect($scrollupArrowNode.is(':hidden'));
    });
    it('is is returning false after isVisible is called and component is not visible', function () {
        // not visible by default
        expect(!scrollupArrow.isVisible());
    });
    it('is is returning true after isVisible is called and component is visible', function () {
        scrollupArrow.show();
        expect(scrollupArrow.isVisible());
    });
